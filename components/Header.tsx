...
export const Header: React.FC<HeaderProps> = ({ toggleTheme, isDarkMode, activeView, setActiveView }) => {
  ...
  const getTitle = () => {
    ...
    switch(activeView) {
        case AppView.DASHBOARD: return s.dashboardTitle;
        case AppView.SEO: return s.seoTitle;
        case AppView.ADS: return s.adsTitle;
        case AppView.CONTENT: return s.contentTitle;
        case AppView.SMM: return s.smmTitle;
        case AppView.INFLUENCERS: return s.influencersTitle;
        case AppView.OPTIMIZER: return s.optimizerTitle;
        case AppView.LANDING_PAGES: return s.landingPagesTitle;
        case AppView.EMAIL: return s.emailMarketingTitle;
        case AppView.AFFILIATE: return s.affiliateMarketingTitle;
        case AppView.CRM: return s.crmTitle;
        case AppView.ANALYTICS: return s.adAnalyticsTitle;
        case AppView.TESTING: return s.testingTitle;
        case AppView.MORE: return s.moreTitle;
        case AppView.SETTINGS: return s.settingsTitle;
        case AppView.CONNECTING: return s.settingsTitle;
        case AppView.OAUTH_CALLBACK: return s.finalizingConnection;
        default: return s.appName;
    }
  }
  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-6 py-4 bg-white dark:bg-gray-800 border-b dark:border-gray-700 shadow-sm">
       <div className="flex items-center space-x-2 rtl:space-x-reverse">
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 text-primary-500">
